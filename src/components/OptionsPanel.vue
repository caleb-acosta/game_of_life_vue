...
<template>
  <div class="options">
    ...
    <form class="probability">
      <div>
        <span :class="{ 'text-deactivated': this.running }"
          >Probability: 0.{{ current_prob }}</span
        >
        <input
          class="range"
          id="prob-slider"
    ...
    <button
      ...
      :class="{ 'btn-deactivated': this.running }"
    >
      Randomize
    </button>
  </div>
